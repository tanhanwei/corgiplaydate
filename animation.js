...
import {LOS, CORGITransform, rotToLookAtDevice, frisbeeFarTargetTransform, frisbeeNearTargetTransform} from "./script.js";
...
export function generateNILAnimation() {
    ...
    animateCORGI(origin, target, lastRotation, lastRotation);    
}
...
export function generateStaticExcitedAnimationFor(selectedAction){
    ...
    let origin = {
        x : CORGITransform.x.pinLastValue(),
        z : CORGITransform.z.pinLastValue()
    };

    var lastRotation = CORGITransform.rotationY.pinLastValue();
    ...
    animateCORGI(origin, target, lastRotation, lookAtDevice);
}
...
export function generateActionAndMoveAnimation(targetType, userTarget){
    ...
    let originRotationY = CORGITransform.rotationY.pinLastValue();
    ...
    animateCORGI(origin, target, originRotationY, targetRotationY);
...
function animateCORGI(origin, target, originRotationY, targetRotationY) {
    ...
    CORGITransform.x = placerAnimationX;
    CORGITransform.z = placerAnimationZ;
    CORGITransform.rotationY = placerRotAnimation;
