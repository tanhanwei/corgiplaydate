...
import { randomLie, randomMove, randomSit, randomStand, moveOrStandNext, generateMoveAction, generateThisStaticAction, generateThisMoveAction, generateNIL, generateStaticPlayAnimation, chaseFrisbee } from "./actions.js";
import { Actions } from "./actionLUT.js";
import { modes } from "./modes";
import { LOSMidPoint, LOSCtrl, CORGITransform } from "./script.js";
...
function changeTypeDecider() {
    var decision = weightedRand({true:0.2, false:0.8});
    return decision();
}
