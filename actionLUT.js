/**
 * Written by Tan Han Wei for Facebook Augmented Reality Hackathon, September 2020
 * These actions correspond to all Playback Controllers.
...
export const Actions = {
    ...
    MOVE: {
        ...
        RUN: {name: 'moveRun', type: 'move', duration: 542, speed: 1.25, loop: true, transition: 'none', typeNo: 1, actionNo: 2},
        WALK: {name: 'moveWalk', type: 'move', duration: 833, speed: 0.25, loop: true, transition: 'none', typeNo: 1, actionNo: 3},
        ...
        NIL: {name: 'moveNil', type: 'move', duration: 42, speed: 0, loop: true, transition: 'none', typeNo: 1, actionNo: 6},
    },
    SIT: {
    ...
    STAND: {
        ...
        IDLE: {name: 'standIdle', type: 'stand', duration: 637, speed: 0, loop: true, transition: 'none', typeNo: 3, actionNo: 6},
