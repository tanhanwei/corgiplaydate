 ...
 * This script is also used to 'force' the Corgi to 'lookat' the device
...
Promise.all([
    ...
    //3D Meshes
    sceneRoot.findFirst('CORGI'),
    sceneRoot.findFirst('GlobalLOS'),

    //for CORGI to look at the device
...
.then(function(objects) {
    ...
    //set CORGI's transform to be exported
...
*/
    ...
    pointer.transform.position = CORGI.transform.position;
